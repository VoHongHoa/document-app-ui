...
export default function HeaderContent() {
    ...
    <div className="bg-cyan-800 py-3 w-full h-14 ">
      <div className="flex flex-row flex-wrap items-center text-white justify-between">
        ...
        <div className="flex flex-row gap-4">
          ...
          <MenuIcon onClick={handleShowList} />
          {showList && (
            <div className="absolute top-14 bg-white text-black p-5 ">
              <ul>
                <li className="p-2">Tài liệu tham khảo</li>
                <li className="p-2">Bộ tài liệu 4.0</li>
                <li className="p-2">Bộ sưu tập</li>
                <li className="p-2">Luận văn, luận đề</li>
              </ul>
            </div>
          )}
        </div>
  ...
  const desktopNavigation: JSX.Element = (
    <div className="bg-cyan-800 py-3 w-full h-14 ">
      <div className="flex flex-row flex-wrap items-center justify-between text-white w-[80%] m-auto">
        <div className="cursor-pointer" onClick={handleReturnHomepage}>
          <img src="https://tailieu.vn/static/b2013az/templates/version1/default/images/tailieu.png" />
        </div>
        <div className="flex flex-row flex-wrap items-center cursor-pointer">
          <MenuIcon />
          <span onMouseEnter={() => handleMouseEnter("subMenu")}>Danh mục</span>
          {isHovered.subMenu && (
            <div
